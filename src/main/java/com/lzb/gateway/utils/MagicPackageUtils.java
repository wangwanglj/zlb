...
public class MagicPackageUtils {
    ...
    public static void main(String[] args) throws SocketException {
        ...
        // 单播
        sendMagicPackage("50-E9-71-00-61-34");
 
        // 广播，需要先根据子网掩码和ip得到主机的广播地址
        String broadcastAddress=getBroadcastAddress("192.168.9.53","255.255.255.0");
     ...
     */
    public static void sendMagicPackage(String mac) throws SocketException {
        log.info("【魔包远程开机】，MAC地址：{}", mac);
        //端口号
        int port = 9;
        //魔术包数据
        /*String magicPacageData = "FFFFFFFFFFFF" +
        ...
        log.info("【魔包远程开机】，MAC地址：{}，魔术包数据：{}", mac, magicPacageData);
        // mac地址转换为2进制的魔术包数据
        ...
        while (interfaces.hasMoreElements()) {
            ...
            for (InterfaceAddress addr : nif.getInterfaceAddresses()) {
                ...
                try {
                    ...
                    //Ip地址错误时候抛出的异常
//                    log.error("【魔包远程开机】异常-Ip地址错误，IP地址：{}，MAC地址：{}，异常信息：{}", mac, e);
